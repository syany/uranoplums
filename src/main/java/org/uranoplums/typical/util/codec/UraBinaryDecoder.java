...
/**
 * UraBinaryDecoderクラス。<br>
 * 
 * @since 2015/06/10
 * @author syany
 */
public interface UraBinaryDecoder extends UraDecoder {
     ...
     */
    byte[] decode(byte[] source) throws UraDecoderRuntimeException;
}
