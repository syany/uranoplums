...
/**
 * UraBinaryEncoderクラス。<br>
 * 
 * @since 2015/06/10
 * @author syany
 */
public interface UraBinaryEncoder extends UraEncoder {
     ...
     */
    byte[] encode(byte[] source) throws UraEncoderRuntimeException;
}
