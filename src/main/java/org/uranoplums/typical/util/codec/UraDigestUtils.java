...
/**
 * UraDigestUtilsクラス。<br>
 * 
 * @since 2014/03/11
 * @author syany
 */
public class UraDigestUtils extends UraUtils {
     ...
     *             built-in algorithm
     * @see UraMessageDigestAlgorithms#MD2
     * @since 1.7
     */
    public static MessageDigest getMd2Digest() {
        return getDigest(UraMessageDigestAlgorithms.MD2);
    }
     ...
     *             built-in algorithm
     * @see UraMessageDigestAlgorithms#MD5
     */
    public static MessageDigest getMd5Digest() {
        return getDigest(UraMessageDigestAlgorithms.MD5);
    }
     ...
     *             built-in algorithm
     * @see UraMessageDigestAlgorithms#SHA_1
     * @since 1.7
     */
    public static MessageDigest getSha1Digest() {
        return getDigest(UraMessageDigestAlgorithms.SHA_1);
    }
     ...
     *             built-in algorithm
     * @see UraMessageDigestAlgorithms#SHA_256
     */
    public static MessageDigest getSha256Digest() {
        return getDigest(UraMessageDigestAlgorithms.SHA_256);
    }
     ...
     *             built-in algorithm
     * @see UraMessageDigestAlgorithms#SHA_384
     */
    public static MessageDigest getSha384Digest() {
        return getDigest(UraMessageDigestAlgorithms.SHA_384);
    }
     ...
     *             built-in algorithm
     * @see UraMessageDigestAlgorithms#SHA_512
     */
    public static MessageDigest getSha512Digest() {
        return getDigest(UraMessageDigestAlgorithms.SHA_512);
    }
    ...
    public static byte[] md2(final String data) {
        return md2(UraStringUtils.getBytesUtf8(data));
    }
    ...
    public static String md2Hex(final byte[] data) {
        return UraHex.encodeHexString(md2(data));
    }
    ...
    public static byte[] md5(final String data) {
        return md5(UraStringUtils.getBytesUtf8(data));
    }
    ...
    public static String md5Hex(final byte[] data) {
        return UraHex.encodeHexString(md5(data));
    }
     ...
     * @return
     */
    public static final String md5Hex(String source, Charset charset) {
        return md5Hex(UraStringUtils.getBytes(source, charset));
    }
    ...
    public static byte[] sha1(final String data) {
        return sha1(UraStringUtils.getBytesUtf8(data));
    }
    ...
    public static String sha1Hex(final byte[] data) {
        return UraHex.encodeHexString(sha1(data));
    }
    ...
    public static byte[] sha256(final String data) {
        return sha256(UraStringUtils.getBytesUtf8(data));
    }
    ...
    public static String sha256Hex(final byte[] data) {
        return UraHex.encodeHexString(sha256(data));
    }
     ...
     * @return
     */
    public static final String sha256Hex(String source, Charset charset) {
        return sha256Hex(UraStringUtils.getBytes(source, charset));
    }
    ...
    public static byte[] sha384(final String data) {
        return sha384(UraStringUtils.getBytesUtf8(data));
    }
    ...
    public static String sha384Hex(final byte[] data) {
        return UraHex.encodeHexString(sha384(data));
    }
     ...
     * @return
     */
    public static final String sha384Hex(String source, Charset charset) {
        return sha384Hex(UraStringUtils.getBytes(source, charset));
    }
    ...
    public static byte[] sha512(final String data) {
        return sha512(UraStringUtils.getBytesUtf8(data));
    }
    ...
    public static String sha512Hex(final byte[] data) {
        return UraHex.encodeHexString(sha512(data));
    }
     ...
     * @return
     */
    public static final String sha512Hex(String source, Charset charset) {
        return sha512Hex(UraStringUtils.getBytes(source, charset));
    }
    ...
    // return DigestUtils
    // .sha256Hex(UraStringUtils.getBytes(source, Charset.defaultCharset()));
    // }
    /**
    ...
    // * @return
    // */
    // public static final String sha384Hex(String source) {
    // return DigestUtils
    // .sha384Hex(UraStringUtils.getBytes(source, Charset.defaultCharset()));
    // }
    /**
    ...
    // * @return
    // */
    // public static final String sha512Hex(String source) {
    // return DigestUtils
    // .sha512Hex(UraStringUtils.getBytes(source, Charset.defaultCharset()));
    // }
    /**
     * Updates the given {@link MessageDigest}.
     * 
    ...
    public static MessageDigest updateDigest(final MessageDigest messageDigest, final String valueToDigest) {
        messageDigest.update(UraStringUtils.getBytesUtf8(valueToDigest));
        return messageDigest;
    }
    // /**
    // * @param source
    // * @return
    // */
    // public static final String md5Hex(String source) {
    // return md5Hex(UraStringUtils.getBytes(source, Charset.defaultCharset()));
    // }
}
