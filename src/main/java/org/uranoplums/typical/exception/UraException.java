 ...
 * @author syany
 */
public class UraException extends ContextedException implements UraObjectCommoner,
        UraExcepter {

    /** シリアル・バージョンUID */
    private static final long serialVersionUID = -3123077246466427230L;
     ...
     * @param message
     */
    public UraException(String message) {
        super(message);
    }
     ...
     * @param cause
     */
    public UraException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @param cause
     */
    public UraException(Throwable cause) {
        super(cause);
    }
     ...
     */
    @Override
    public UraException clone() {
        try {
            return (UraException) super.clone();
